...
class TestDecodeOptions(TestDecoderLib):
    ...
    def test_invalid_error_correction(self):
        ...
        with pytest.raises(ValueError, match="Error correction must be 'low', 'medium', or 'high'"):
...
class TestDecodeVisual(TestDecoderLib):
    ...
    def test_raises_not_implemented(self):
        ...
        with pytest.raises(NotImplementedError, match="Visual CLIP decoding is planned for a future release"):
...
class TestEncodeVisual(TestDecoderLib):
    ...
    def test_raises_not_implemented(self):
        ...
        with pytest.raises(NotImplementedError, match="Visual CLIP encoding is planned for a future release"):
