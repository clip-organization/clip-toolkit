...
class CLIPFetcher:
    ...
    def fetch(self, source: str, use_cache: bool = True, validate: bool = True) -> Dict[str, Any]:
        """
    ...
    async def fetch_async(self, source: str, use_cache: bool = True, validate: bool = True) -> Dict[str, Any]:
        """
        ...
        """
        return await self._async_fetcher.fetch(source, use_cache=use_cache, validate=validate)
    
    def fetch_from_url(self, url: str, use_cache: bool = True, validate: bool = True) -> Dict[str, Any]:
        """
    ...
    async def fetch_from_url_async(self, url: str, use_cache: bool = True, validate: bool = True) -> Dict[str, Any]:
        """
        ...
        Raises:
            AsyncCLIPFetchError: If fetching fails
        """
        return await self._async_fetcher.fetch_from_url(url, use_cache=use_cache, validate=validate)
    ...
    async def fetch_from_file_async(self, file_path: str, validate: bool = True) -> Dict[str, Any]:
        """
    ...
    async def fetch_multiple_async(self, sources: List[str], use_cache: bool = True, validate: bool = True,
        ...
        Note:
            ...
            Use get_failed_sources() to check for failures.
        """
        results = await self._async_fetcher.fetch_multiple(sources, use_cache, validate, max_concurrent)
    ...
    async def fetch_batch_async(self, sources: List[str], use_cache: bool = True, validate: bool = True,
        ...
        """
        results = await self._async_fetcher.fetch_batch(sources, use_cache, validate, max_concurrent)
    ...
    async def discover_from_directory_async(self, directory: str, recursive: bool = True) -> List[str]:
        """
    ...
    def prefetch_urls(self, urls: List[str], use_cache: bool = True) -> Dict[str, Any]:
        ...
        logger.info(f"Prefetch completed: {len(results['successful'])} successful, "
                   f"{len(results['failed'])} failed, {len(results['cached'])} cached")
        
        return results
    
    async def prefetch_urls_async(self, urls: List[str], use_cache: bool = True, 
