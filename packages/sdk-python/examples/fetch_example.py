...
def create_sample_clip_files(temp_dir: Path):
    ...
    venue_clip = {
        ...
        "description": "A modern public library with extensive resources and community programs.",
        ...
        "features": [
            ...
            },
            {
                ...
                "available": 20,
                "metadata": {
                    "description": "Public computer access with internet"
                }
            }
        ],
        "actions": [
...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            print(f"✓ Created CLIPObject: {clip_obj}")
            ...
            print(f"   ✓ Added feature, updated timestamp")
        ...
        try:
            cached_fetcher = CLIPFetcher(cache_enabled=True, cache_dir=str(temp_path / "cache"))
    ...
    print("   fetcher.fetch('https://example.com/clip.json')  # Auto-detects URL vs file")
