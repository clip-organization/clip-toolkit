...
class TestCLIPLocation:
    ...
    def test_invalid_coordinates(self):
        ...
        with pytest.raises(
            ValueError, match="coordinates must have latitude and longitude"
        ):
...
class TestCLIPObject:
    ...
    def test_invalid_last_updated(self):
        ...
        with pytest.raises(
            ValueError, match="lastUpdated must be a valid ISO 8601 datetime"
        ):
            CLIPObject(
                **{
                    "@context": "https://clipprotocol.org/v1",
    ...
    def test_update_timestamp(self):
        ...
        parsed_time = datetime.fromisoformat(
            clip_obj.lastUpdated.replace("Z", "+00:00")
        )
    ...
    def test_add_service(self):
        ...
        clip_obj.add_service(
            "http", "https://api.app.com", capabilities=["query", "action"]
        )
